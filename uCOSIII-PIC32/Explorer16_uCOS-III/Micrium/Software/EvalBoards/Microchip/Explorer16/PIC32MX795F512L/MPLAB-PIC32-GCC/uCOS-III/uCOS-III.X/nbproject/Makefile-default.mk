...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/uCOS-III.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/1472/app.o: ../app.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/app.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"../../../../../../../uCOS-III/Source" -I"../../../../../../../uCOS-III/Ports/MIPS32-4K/Vectored-Interrupt/MPLAB-PIC32-GCC" -I"../../../../../../../uC-CPU" -I"../../../../../../../uC-LIB" -I"../../../../../../../uC-CPU/MIPS32-4K/MPLAB-PIC32-GCC" -I"../../../../../../../CPU/Microchip/PIC32" -I"../../BSP" -I"../" -MMD -MF "${OBJECTDIR}/_ext/1472/app.o.d" -o ${OBJECTDIR}/_ext/1472/app.o ../app.c   
...
dist/${CND_CONF}/${IMAGE_TYPE}/uCOS-III.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION) -nostartfiles -o dist/${CND_CONF}/${IMAGE_TYPE}/uCOS-III.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION)
